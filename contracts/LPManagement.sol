// filepath: /Users/davidkoehn/projects/lp-dapp/contracts/LPManagement.sol
...
contract LPManagement is Pausable, ReentrancyGuard {
    ...
    function setCommitment(
        ...
        require(
            _amountETH * getETHUSDCExchangeRate() >= minCommitmentAmountUSD * 10**18,
            "Commitment amount must be greater than minimum amount"
        );        
    ...
    function createCashCall(address _lp, uint256 _amount, uint256 _deadline) external whenNotPaused onlyAdmin {
        ...
        require(
            _deadline > block.timestamp && _deadline <= lpData[_lp].endTime,
